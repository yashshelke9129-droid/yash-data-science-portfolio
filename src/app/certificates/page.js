          ...
          {credentialRegistry.map((cert, idx) => (
            ...
            >
              <div>
                ...
                <h2 className="text-2xl font-bold text-white mb-1 tracking-tight">{cert.title}</h2>
                <p className="text-xs font-mono text-cyan-400 uppercase tracking-wider mb-4">{cert.issuer}</p>
                <p className="text-slate-400 text-sm leading-relaxed mb-8">{cert.scope}</p>
              </div>
