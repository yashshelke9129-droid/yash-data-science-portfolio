...
const credentialRegistry = [
  {
    ...
    scope:
      "Core exploration tracking, programmatic extraction syntax, feature matrices logic, and foundational distribution distributions analytics.",
    icon: "📊",
...

  {
    ...
    scope:
      "Engineered production predictive layers, completed exploratory notebook documentation, and managed end-to-end data pipelines.",
    icon: "🔬",
...

  {
    ...
    issuer: "IBM Developer Skills Network & Cognitive Class",
    scope:
      "Built strong foundations in Python programming including data structures, loops, functions, conditionals, file handling, and practical applications for data science and analytics.",
    icon: "🐍",
    pdfPath: "/certificates/IBM-DS-for-Python.pdf",
  },

  {
    ...
    issuer: "IBM Developer Skills Network & Cognitive Class",
    scope:
      "Learned R programming for statistical analysis, data visualization, exploratory data analysis, and modern data science workflows used in real-world analytical projects.",
    icon: "📈",
    pdfPath: "/certificates/IBM-DS-for-R.pdf",
  },
...
export default function Certificates() {
  return (
    <>
      ...
      <main className="min-h-screen pt-32 pb-20 px-6 max-w-7xl mx-auto matrix-grid text-white">
