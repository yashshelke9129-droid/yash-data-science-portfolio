          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} className="space-y-8">
              ...
              <div className="space-y-6 text-slate-400 leading-relaxed text-lg">
                ...
                <p>
                  I don't just write code; I construct logic. My approach to Data Science is iterative—ingesting raw datasets, applying rigorous statistical frameworks, and extracting insights that drive meaningful business decisions.
                </p>
              </div>
            </motion.div>
